...
## Windows (方法1)
1. 以管理員身分執行終端機
![](https://cdn.mwtw.net/blog/hotspot_detect_bypass/hotspot_detect_bypass_1.png)
2. 輸入 `netsh int ipv4 set glob defaultcurhoplimit=65`
3. 輸入 `ping 127.0.0.1`，查看 TTL 是否為 65
![](https://cdn.mwtw.net/blog/hotspot_detect_bypass/hotspot_detect_bypass_2.png)
## Windows (方法2)
1. 在鍵盤輸入 `Win + R` 開啟執行，輸入 `regedit` 開啟登錄編輯程式。
![](https://cdn.mwtw.net/blog/hotspot_detect_bypass/hotspot_detect_bypass_3.png)
...
![](https://cdn.mwtw.net/blog/hotspot_detect_bypass/hotspot_detect_bypass_5.png)
6. 重開機

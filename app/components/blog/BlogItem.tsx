    ...
    >
      <div className="relative aspect-video h-auto w-full">
        {page.data.image != null ? (
          ...
          <div className="flex h-full flex-1 flex-col bg-unknown">
            {/* <Image
              alt="logo"
              src="https://i.imgur.com/vtWpd68.png"
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <p className="mt-auto pt-2 text-end text-sm text-muted-foreground">
          {page.data.date.toLocaleString("zh", {
              dateStyle: "long",
            })}
        </p>
      </div>
    ...
    >
      <div className="relative aspect-video w-full">
        {page.data.image != null ? (
          ...
          <div className="flex h-full flex-1 flex-col bg-green-400 bg-unknown">
            {/* <Image
              alt="logo"
              src="https://i.imgur.com/yDTGlZE.png"

import { LinkButton } from "@/app/components/blog/LinkButton";
import Link from "next/link";
import { getTagHref, getTags, type TagInfo } from "@/app/utils/tags";
  ...
  return (
    <main className="my-16 flex w-full flex-col gap-3">
      <div className="mb-3 flex flex-col gap-3">
        <h1 className="mb-4 text-center text-5xl font-bold">我の書籤</h1>
        <LinkButton
          href="/blog"
